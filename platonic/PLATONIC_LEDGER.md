...
**not a volume of the programme**. Its own subject is arithmetic: shadow $L$-functions, Kummer and Bernoulli structure, and the Hilbert–Pólya reading of the chiral spectrum. **None of that appears in the spine.** The integrated monograph is built here so a plain build produces the current programme text, but this repository's arithmetic capstone has not been carried into it and no claim is made that the spine supersedes it.
...
| — | arithmetic capstone, not in the spine | `chiral-bar-cobar-vol4`, standalone |
