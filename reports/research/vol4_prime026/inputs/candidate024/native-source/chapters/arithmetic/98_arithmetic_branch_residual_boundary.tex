...
Hypothesis. The theorem below separates the two inputs:
...
A-TP is the remaining RH-equivalent positivity obstruction in the
quantum ACS construction; the comparison and regularity hypotheses are
separate conditions.
\end{theorem}
...
ACS datum; A-TP is the positivity half. RH is equivalent to A-TP
...
\begin{proof}
Chapters~\ref{v4-arith:w6-a:ATP-direct-obstruction}--\ref{v4-arith:w7-j:ATP-adelic-scattering}
...
identifies this residual with RH.  The other inputs
are comparison or construction hypotheses, not zero-placement
statements.
\end{proof}
