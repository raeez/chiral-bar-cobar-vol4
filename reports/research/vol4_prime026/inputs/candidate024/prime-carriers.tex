\section{Normalization and the spaces of prime distributions}
...
\end{lemma}
\begin{proof}
In the theta integral \eqref{mo:xi-integral}, the theta
...
\section{The explicit formula on compact Fourier tests}
...
\section{Centering and the critical exponent}
