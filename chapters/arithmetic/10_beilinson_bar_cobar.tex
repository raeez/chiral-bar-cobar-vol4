...
The theorem-grade version used by the later arithmetic branch is
\Cref{v4-arith:thm:arithmetic-positselski}; this statement is the
Chapter~10 preview of the same Positselski mechanism.
