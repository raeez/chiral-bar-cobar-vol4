...
\Cref{v4-arith:closure:thm:Heisenberg-selfduality}.
\end{proposition}
...
\Cref{v4-arith:closure:lem:kappa-balance}). The LS correction
...
\Cref{v4-arith:closure:lem:kappa-balance}. Hence
