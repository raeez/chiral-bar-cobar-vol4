...
\emph{Wave-6, agent~C. Chapter~\ref{v4-arith:w5-c:full-vprim-P3}
(wave-5) closed the Koszul--Petersson compatibility on the
...
\label{v4-arith:w6-c:LS:attack-heal}

\begin{remark}[seven-attack protocol for \Cref{v4-arith:w6-c:thm:main}]
\label{v4-arith:w6-c:rem:attack-heal}
\begin{description}
...
Chapter~\ref{v4-arith:w5-c:full-vprim-P3} Wave-5 closed the
...
fully supplied by Repair~(a) alone. Wave-6 Repair~(b), executed in
