...
prismatic sheaf on the global Emerton--Gee stack. The net result is
...
arXiv:1908.07185). Let $\mathcal{X}^{\mathrm{EG,glob}}_{G}$ be the
global Emerton--Gee stack
(\Cref{v4-arith:thm:emerton-gee}); it is the colimit of the local
stacks glued along the diagonal embeddings and an archimedean factor.
...
$\mathcal{F}_{\mathrm{glob}}^{\mathrm{prism}}\in\mathrm{Coh}(\mathcal{X}^{\mathrm{EG,glob}}_{G})$
...
$\Delta_{p,q}\colon\mathcal{X}^{\mathrm{EG},\{p,q\}}_{G}\hookrightarrow\mathcal{X}^{\mathrm{EG,glob}}_{G}$
be the closed immersion of the two-prime stratum of the global
Emerton--Gee stack into the global stack (the stratum where the
...
\Delta_{p,q}^{*}\colon\mathrm{Coh}(\mathcal{X}^{\mathrm{EG,glob}}_{G})\longrightarrow\mathrm{Coh}(\mathcal{X}^{\mathrm{EG},\{p,q\}}_{G}).
\end{equation}
...
$\mathrm{IndCoh}_{\mathrm{Nilp}}(\mathcal{X}^{\mathrm{EG,glob}}_{G})$,
...
$\Gamma(\mathcal{X}^{\mathrm{EG,glob}}_{G},\mathcal{O})^{\mathrm{GL_{2}-inv}}$
...
$\mathcal{Z}_{\mathrm{glob}}=\Gamma(\mathcal{X}^{\mathrm{EG,glob}}_{G},\mathcal{F}_{\mathrm{glob}}^{\mathrm{prism}})^{GL_{2}\text{-inv}}$
...
R^{\mathrm{Ch}}\;=\;\Gamma\bigl(\mathcal{X}^{\mathrm{EG,glob}}_{G},\mathcal{O}\bigr)^{GL_{2}\text{-inv}}
\end{equation}
...
$\Gamma(\mathcal{X}^{\mathrm{EG,glob}}_{G},\mathcal{O})^{GL_{2}\text{-inv}}$
...
$\Gamma(\mathcal{X}^{\mathrm{EG,glob}}_{G},\mathcal{O})$ in the
