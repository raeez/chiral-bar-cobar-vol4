...
summand unconditionally, using Breuil--M{\'e}zard numerical = geometric
...
JEMS~16 (2014) for \(p=2\) and Colmez--Dospinescu--Pa{\v
s}k{\=u}nas Cambridge J.~Math.~2 (2014) for \(p=3\), recording
...
\subsection{Source Disjointness and Convention Audit for F1.a.1}
...
Fargues--Scholze arXiv:2102.13459 (spectral-action). The HZ-IV
disjointness audit passes on the unramified ordinary range.
...
\subsection{Source Disjointness and Convention Audit for F1.a.2}
...
\subsection{Source Disjointness and Convention Audit for \(\mathrm{L}_{\mathrm{ACD}}\)}
...
The cuspidal sph-fin locus closes; the Eisenstein extension is a
named residual.
...
estimate of 175--285 pages itemised in the proof (a reduction of
approximately 40\% through elementary primary-literature assembly).
\end{proposition}
...
(\Cref{v4-arith:w5-e:thm:f1a2}).} Pa{\v s}k{\=u}nas JEMS~16 (2014) at \(p=2\)
