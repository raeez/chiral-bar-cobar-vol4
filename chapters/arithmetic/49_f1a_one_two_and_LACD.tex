...
\emph{Three residuals remain in the F1 ledger after waves 1--4: the
...
JEMS 2013 arXiv:1311.3048 for $p=2$ and Colmez--Dospinescu--Pa{\v
s}k{\=u}nas Inventiones 2014 arXiv:1310.7499 for $p=3$, recording
...
algebra.
\item[Pa{\v s}k{\=u}nas arXiv:1311.3048] ``Blocks for $\bmod{p}$
representations of $GL_{2}(\mathbb{Q}_{p})$'' = JEMS~16 (2014) \S 2--5.
Block decomposition at $p=2$.
\item[Colmez--Dospinescu--Pa{\v s}k{\=u}nas arXiv:1310.7499]
``The $p$-adic local Langlands correspondence for $GL_{2}(\mathbb{Q}_{p})$'',
Cambridge J.~Math.~2 (2014) = arXiv:1310.7499. $p=3$ and reducible
...
The derivation sources backing the wave-2 DEG reduction
...
s}k{\=u}nas arXiv:1311.3048 and Colmez--Dospinescu--Pa{\v s}k{\=u}nas
arXiv:1310.7499 are block-structure theorems at $p=2$ and $p=3$ that
...
\begin{itemize}
\item Pa{\v s}k{\=u}nas arXiv:1311.3048 (= JEMS~16, 2014) treats
...
\begin{proof}[Source]
Pa{\v s}k{\=u}nas arXiv:1311.3048 \S 2--5 (JEMS~16). The block
...
\begin{proof}[Source]
Colmez--Dospinescu--Pa{\v s}k{\=u}nas arXiv:1310.7499 Theorem 1.1
...
arXiv:1311.3048 and Colmez--Dospinescu--Pa{\v s}k{\=u}nas
arXiv:1310.7499 are block-decomposition theorems independent of
...
\begin{proposition}[refined F1 residual ledger after wave-5 E]
