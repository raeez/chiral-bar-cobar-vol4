...
\emph{The reduction of F2 through~\Cref{v4-arith:thm:F2-reduction}
...
unconditionally. It does not prove the mixed-characteristic Iwahori
$E_{2}$ local input F2.b; therefore F2 itself remains
theorem-waiting.}
...
We executed six attack-and-repair cycles against
...
Prior to this chapter F2.c was conjectural; after
\Cref{v4-arith:tate:thm:F2-closure} F2.c is
a theorem. F2 itself is not a theorem until the local
mixed-characteristic Iwahori $E_{2}$ enhancement F2.b is supplied.
Downstream uses of F2 remain conditional on that local input.
\end{remark}
...
The cost of F2.c was a $\sim$25-page application of the
...
but does not move F2 from conjecture/theorem-waiting to theorem.
