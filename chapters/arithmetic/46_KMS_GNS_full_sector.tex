...
\emph{Route~4. Chapter~\ref{v4-arith:kp-compat} scope-restricted
Koszul--Petersson compatibility to the normalised sph-fin cuspidal
core of $\mathcal{V}^{\mathrm{prim}}$; route~3
...
\subsection{The Three Residuals from Route~3}
...
verified; route~3 flagged this as an open sub-item.
...
\begin{remark}[scope tightening from route~3]
\label{v4-arith:kms-gns:rem:w3-tightening}
Route~3 (\Cref{v4-arith:w3-audit-B:repair-26}) scope-restricted
...
\begin{remark}[scope enlargement relative to route~3]
\label{v4-arith:kms-gns:rem:P3-scope-enlargement}
Route~3 (\Cref{v4-arith:w3-audit-B:repair-26}) recorded P3 as
...
route~3's sph-fin cuspidal P3 by removing the spherical restriction
...
The route~4 progress: of the three open sub-items isolated by
route~3 (I, II, III), one is closed unconditionally (I), one is
...
clean operator-algebra fact that route~3 correctly flagged as open.
