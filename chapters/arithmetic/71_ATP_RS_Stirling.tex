...
Chapter~\ref{v4-arith:w6-a:ATP-direct-attack}. Fourth, a
...
Riemann--Siegel theta function, are the content of this chapter.
...
\begin{remark}[Source independence and sign verification for the exact identity]
\label{v4-arith:w7-a:rem:verification-identity}
Seven independent checks on \Cref{v4-arith:w7-a:thm:exact-identity}.
...
\begin{remark}[Source independence and sign verification for the threshold]
\label{v4-arith:w7-a:rem:verification-threshold}
...
\begin{remark}[Source independence and numerical verification for the residual theorem]
\label{v4-arith:w7-a:rem:verification-irreducible}
...
None of (1)--(4) closes A-TP on the full cone; each is a research
programme equivalent in strength to de Branges, Connes, Deninger,
or Hardy. The route~7 A closure is that the Stirling
