...
The five attack-and-repair cycles of this chapter apply the seven-attack
...
\section{Residual Scope and Attack-and-Repair Traces}
...
\subsection{Attack-and-Repair Trace for Cycle 1 (BH tame-wild at $p=2$)}
...
\subsection{Attack-and-Repair Trace for Cycle 2 (BH tame-wild at $p=3$)}
...
\subsection{Attack-and-Repair Trace for Cycle 3 (essential surjectivity)}
...
\subsection{Attack-and-Repair Trace for Cycle 4 (wild-EG cross-check)}
...
\subsection{Attack-and-Repair Trace for Cycle 5 (unconditional-closure attempt)}
