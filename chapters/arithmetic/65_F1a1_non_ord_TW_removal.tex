...
\subsection{Attack-and-Repair Trace (F1.a.1.non-ord)}
...
\subsection{Attack-and-Repair Trace (F1.a.1.TW-removal)}
...
\subsection{Refined F1 Residual Ledger after Route~6 E}
...
(route~5 E) and this chapter (route~6 E), the F1.a.1 residual
...
\begin{proposition}[F1 ledger after routes 5 E and 6 E combined]
...
ledger after route~6 E has five sub-residuals:
\begin{enumerate}
...
\end{enumerate}
Total scope $74$--$128$ pp, down from the before Route~6-E estimate of
$100$--$165$ pp, with F1.a.1 internal reduction from $35$--$55$ pp
to $9$--$18$ pp.
\end{proposition}

\begin{proof}
Tabulation from \Cref{v4-arith:w5-e:prop:F1-ledger-refined} (before Route~6-E)
