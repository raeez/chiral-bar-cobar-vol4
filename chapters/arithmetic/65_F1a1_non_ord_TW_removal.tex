...
Chapter~\ref{v4-arith:w5-e:chapter} established essential surjectivity of the
Dotto--Emerton--Gee functor \(\Phi^{\mathrm{DEG}}_{p,\chi}\) on the unramified ordinary
summand under the full Taylor--Wiles conditions (TW1)--(TW4). Two ranges of
\(\mathcal{X}^{\mathrm{EG},p,\chi,\bar\rho}_{GL_{2}}\) remained: the non-ordinary locus
(potentially Barsotti--Tate and supersingular sub-components at \(p\geq 5\)) and the
residuals for which (TW2) or (TW3) fails (dihedral, nearly-ordinary, and Serre-type).

The present chapter closes the non-ordinary range on the potentially Barsotti--Tate
sub-locus via Kisin 2008 J.~AMS~21, Gee--Kisin 2014, Emerton--Gee arXiv:1109.4226
\S 7, and Colmez 2010; the genuinely supersingular core remains open at \(6\)--\(12\) pp.
Essential surjectivity beyond the Taylor--Wiles conditions is established on the union
of the dihedral sector (Arthur--Clozel 1989, Taylor 2003 Pub.~IHES~98), the
nearly-ordinary sector (Skinner--Wiles 1999), and the Serre-modular sector
(Khare--Wintenberger 2009, Kisin 2009 J.~AMS~22); the non-solvable non-nearly-ordinary
core remains open at \(3\)--\(6\) pp.
...
of \Cref{v4-arith:w6-e:lem:GK-BM-pBT}: the structure sheaves
\(\mathcal{O}_{\mathcal{X}^{\mathrm{BM},\tau}}\) satisfy a
\v{C}ech-type gluing condition on pairwise intersections
\(\mathcal{X}^{\mathrm{BM},\tau}\cap\mathcal{X}^{\mathrm{BM},\tau'}\),
which are Cohen--Macaulay of codimension two by
\Cref{v4-arith:w6-e:lem:GK-BM-pBT}; the DEG gluing data restricted
to these intersections agrees with the Montreal functor's output by
a direct computation on projective covers (DEG \S 4.3). The image
of \(\widetilde{\pi}_{\tau}\) under \(\Phi^{\mathrm{DEG}}_{p,\chi}\)
therefore coincides with its image under the Colmez Montreal functor,
namely \(\mathcal{O}_{\mathcal{X}^{\mathrm{BM},\tau}}\).
...
\begin{corollary}[unconditional essential surjectivity on the pBT non-ordinary sub-component]
...
The open range for the non-ordinary locus therefore reduces to the
supersingular core
...
The original open range for the non-ordinary locus, scoped at \(20\)--\(30\) pages,
...
Kisin 2008 J.~AMS~21 \S 3. The scope reduction is a factor of
...
\paragraph{Open sub-conjecture.} No conjecture is invoked on the pBT
sub-locus; all inputs are theorems. The supersingular core is recorded as
\Cref{v4-arith:w6-e:conj:f1a1-ss-residual}, an open sub-conjecture of
scope \(6\)--\(12\) pages.
...
\begin{corollary}[unconditional essential surjectivity range after Taylor--Wiles removal]
\label{v4-arith:w6-e:cor:TW-removal-uncond}
\ClaimStatusProvedHere. The open range for essential surjectivity beyond (TW2) and (TW3) reduces to the
...
\subsection{Source Disjointness and Hypothesis Verification for the Taylor--Wiles Removal}

\paragraph{Source disjointness.} Khare--Wintenberger 2009 proves
...
Calabi--Yau construction. These five sources are pairwise disjoint
in methodology, and all are disjoint from DEG arXiv:2603.26887 and
from the Kisin 2009 / Gee--Kisin 2014 / Emerton--Gee arXiv:1109.4226
catalog used in \S\ref{v4-arith:w6-e:non-ord}.
...
\paragraph{Replacement hypotheses.} Condition (TW1) (\(p\geq 5\)) is
retained. Conditions (TW2) (big image) and (TW3) (distinguishedness)
are removed; each sector carries an explicit replacement: dihedral
residuals are induced from a quadratic extension; nearly-ordinary
residuals admit a nearly-ordinary lift; Serre-modular residuals are
covered by Khare--Wintenberger. These conditions are automatic or
structurally verifiable via Dickson's classification and the
Skinner--Wiles hypothesis respectively.
...
\paragraph{Open sub-conjecture.} No conjecture is invoked on the
three covered sectors; all inputs are theorems. The non-solvable
non-nearly-ordinary residual is recorded as
\Cref{v4-arith:w6-e:conj:TW-removal-ns-residual}, with scope
\(3\)--\(6\) pp.

\section{Combined Closure on the Maximal Unconditional Range for \(\Phi^{\mathrm{DEG}}_{p,\chi}\)}
\label{v4-arith:w6-e:assembly}

\subsection{Union of the Two Chapter-Level Closures}

\begin{theorem}[essential surjectivity of \(\Phi^{\mathrm{DEG}}_{p,\chi}\) on the maximal unconditional range]
...
\subsection{Refined Residual Ledger after the Non-Ordinary and Taylor--Wiles Closures}

\begin{proposition}[refined residual decomposition for essential surjectivity on the non-ordinary and non-Taylor--Wiles loci]
\label{v4-arith:w6-e:prop:F1-ledger-refined}
\ClaimStatusProvedHere. After Chapter~\ref{v4-arith:w5-e:chapter}
and this chapter, the open range of
\(\Phi^{\mathrm{DEG}}_{p,\chi}\) on the non-ordinary and
non-Taylor--Wiles loci decomposes into two sub-residuals of combined
scope \(9\)--\(18\) pp:
\begin{enumerate}
\item Supersingular core
(\Cref{v4-arith:w6-e:conj:f1a1-ss-residual}): essential surjectivity
on the genuinely supersingular sub-locus at \(p\geq 5\), \(6\)--\(12\) pp.
...
residual sector, \(3\)--\(6\) pp.
\end{enumerate}
The total open scope is \(9\)--\(18\) pp, reduced from the pre-chapter
\(35\)--\(55\) pp (non-ordinary locus \(20\)--\(30\) pp plus
non-Taylor--Wiles removal \(15\)--\(25\) pp). The reduction is
\(65\)--\(70\) percent, achieved by primary-literature assembly.
\end{proposition}

\begin{proof}
Non-ordinary locus: pre-chapter scope \(20\)--\(30\) pp; closed on the pBT
sub-locus via \Cref{v4-arith:w6-e:thm:f1a1-pBT-nonord}; open residual
\Cref{v4-arith:w6-e:conj:f1a1-ss-residual}, \(6\)--\(12\) pp.
Non-Taylor--Wiles locus: pre-chapter scope \(15\)--\(25\) pp; closed on the
dihedral, nearly-ordinary, and Serre-modular sectors via
\Cref{v4-arith:w6-e:thm:TW-removal-union}; open residual
\Cref{v4-arith:w6-e:conj:TW-removal-ns-residual}, \(3\)--\(6\) pp. Total
open scope: \(6\)--\(12\) + \(3\)--\(6\) = \(9\)--\(18\) pp.
\end{proof}

\subsection{Interaction with the Full Essential Surjectivity Ledger}

\begin{proposition}[essential surjectivity residual ledger after the ordinary and non-ordinary closures]
\label{v4-arith:w6-e:prop:F1-ledger-combined}
\ClaimStatusProvedHere. Combining
\Cref{v4-arith:w5-e:prop:F1-ledger-refined} with
\Cref{v4-arith:w6-e:prop:F1-ledger-refined}, the full residual
ledger for essential surjectivity of \(\Phi^{\mathrm{DEG}}_{p,\chi}\)
has five open sub-ranges:
\begin{enumerate}
\item Supersingular core (\(6\)--\(12\) pp).
\item Non-solvable non-nearly-ordinary core (\(3\)--\(6\) pp).
...
\end{enumerate}
Total open scope \(74\)--\(128\) pp, reduced from the pre-chapter estimate of
\(100\)--\(165\) pp, with the non-ordinary and non-Taylor--Wiles closures
reducing the relevant component from \(35\)--\(55\) pp to \(9\)--\(18\) pp.
\end{proposition}

\begin{proof}
Direct combination of \Cref{v4-arith:w5-e:prop:F1-ledger-refined}
and \Cref{v4-arith:w6-e:prop:F1-ledger-refined}.
\end{proof}
...
\begin{enumerate}
\item \textbf{Non-ordinary locus closed on the potentially Barsotti--Tate sub-component}
(\Cref{v4-arith:w6-e:thm:f1a1-pBT-nonord}). Inputs: Kisin 2009
J.~AMS~21 (pBT flatness and reducedness), Gee--Kisin 2014
(geometric Breuil--M{\'e}zard), Emerton--Gee arXiv:1109.4226 \S 7
(Newton--Hodge stratification), Colmez 2010 \S 9 (Montreal functor
on the pBT block). Open residual: supersingular core
(\Cref{v4-arith:w6-e:conj:f1a1-ss-residual}), \(6\)--\(12\) pp.
\item \textbf{Taylor--Wiles conditions removed on the dihedral, nearly-ordinary,
...
Khare--Wintenberger 2009 (Serre's modularity conjecture), Kisin 2009 J.~AMS~22
(modularity lifting from residual modularity), Gee 2011 Math.~Ann.~350
(Breuil--M{\'e}zard cycle matching). Open residual:
non-solvable non-nearly-ordinary core
(\Cref{v4-arith:w6-e:conj:TW-removal-ns-residual}), \(3\)--\(6\) pp.
\item \textbf{Refined open-range decomposition}
(\Cref{v4-arith:w6-e:prop:F1-ledger-refined}). Essential surjectivity
of \(\Phi^{\mathrm{DEG}}_{p,\chi}\) is established unconditionally
except for two sub-ranges summing to \(9\)--\(18\) pp; this is a
\(65\)--\(70\) percent reduction from the pre-chapter open scope of
\(35\)--\(55\) pp. The global open-range count
(\Cref{v4-arith:w6-e:prop:F1-ledger-combined}) is five sub-ranges,
total scope \(74\)--\(128\) pp.
\item \textbf{Two open sub-ranges.} The supersingular core reduces to
Emerton--Gee arXiv:1109.4226 \S 8 via a direct Newton-stratification
extension of the pBT argument. The non-solvable non-nearly-ordinary
core reduces to Taylor 2003 Pub.~IHES~98, Barnet-Lamb--Gee--Geraghty 2012
J.~AMS~25, and Emerton 2011 Invent.~Math.~184, via compact-generator
checks on sub-loci that already admit the appropriate modularity-lifting
and base-change input.
\end{enumerate}

The chapter closes the non-ordinary and non-Taylor--Wiles loci on their
natural core domains. The two open sub-ranges isolated here (supersingular
core, \(6\)--\(12\) pp; non-solvable non-nearly-ordinary core, \(3\)--\(6\) pp)
are each a strict sub-component of the original open range. No new
conjectural inputs beyond those already in the prior chapters are
introduced.
