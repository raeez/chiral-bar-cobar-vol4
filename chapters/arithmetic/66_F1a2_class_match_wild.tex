...
\emph{Wave-6 agent F closes the three wave-5 residuals of the Paskunas
...
\subsection{The Three Wave-5 Residuals}

Wave-5 left three named residuals in the Paskunas lane:
\begin{itemize}
\item \textbf{F1.a.2.class-match} (wave-5 agent E,
...
\item \textbf{R.B.1} (wave-5 agent F,
...
Scope $2$--$4$ pp.
\item \textbf{R.B.2} (wave-5 agent F,
...
\subsection{Primary Sources Beyond Wave-5}

Closures in this chapter cite the following primary sources disjoint
from the wave-5 F1.a.2 and F1.a.3 closures:
\begin{description}
...
The derivation sources backing wave-5 F1.a.2 and F1.a.3.A+B are
...
Wave-5 agent E reduced F1.a.2 to the class-level compatibility
...
\begin{theorem}[wave-6 update of the F1.a.3 ledger]
...
\begin{corollary}[post-wave-6 F1.a.3 surviving ledger]
\label{v4-arith:w6-f:cor:surviving-ledger}
\ClaimStatusProvedHere. After wave-6 agent F, the F1.a.3 ledger is
...
Compared to the $13$--$26$ pp wave-5 ledger, the reduction is
$40$--$60\%$ by page count.
\end{corollary}
...
\section{Attack--Heal Protocol}
\label{v4-arith:w6-f:attack-heal}
...
disjoint from the wave-5 derivation set
...
disjoint from the wave-5 Paskunas 2015 primary set. \textbf{Pass.}
...
disjoint from wave-5 Pa\v skunas 2013 (regular-local dimension) and
...
\item Three attack-heal cycles pass all seven attacks; disjointness
is preserved throughout; no new Pa\v skunas-source-derivation loop
appears.
\end{enumerate}

The chapter retires the full wave-5 Paskunas-lane residual set
...
Primary sources used in this chapter (all external to the wave-5
derivation catalogs):
...
2015, disjoint from the wave-5 Pa\v skunas 2015 main statement.
