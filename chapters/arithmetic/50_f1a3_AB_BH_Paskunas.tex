...
Emerton--Paskunas). The dimension bound
...
\paragraph{Attack 1.} Add sources: Paskunas 2013
...
resolution on regular local); Paskunas 2015
...
Paskunas 2015 (Breuil--Mezard multiplicity update);
Emerton--Paskunas (reconciliation of earlier
...
\item V.~Paskunas, ``On the Breuil--M\'ezard conjecture'' (2015).
