...
\emph{Wave-7 agent F. Adversarial attack on the archimedean Tate
...
that was open after wave-6 Chapter~\ref{v4-arith:w6-a:ATP-direct-attack}.
...
present chapter, like wave-5 and wave-6, names the irreducible
...
\begin{remark}[strict improvement over wave-6]
...
improvement of the wave-6 content of
Chapter~\ref{v4-arith:w6-a:ATP-direct-attack}: wave-6 left this
...
non-empty region missed by wave-6. The structural difference: the
...
\section{The Irreducible Obstruction After Wave-7 F}
\label{v4-arith:w7-f:irreducible}

We consolidate what remains open.

\begin{theorem}[wave-7 F residual]
...
\end{equation}
the union of the wave-6 high-frequency dominance class and the new
wave-7 F Hankel dominance class. This union is strictly larger than
...
The wave-7 F residual \eqref{v4-arith:w7-f:eq:wave7f-residual}
...
is a strict improvement over wave-6.
...
\item The wave-7 F residual is the complement
...
The wave-7 F deliverable obeys the Beilinson principle: a strict
enlargement of the unconditional closure from
$\mathrm{PW}^{\mathrm{hol},\mathrm{HFD}}_{F}$ (wave-6) to
$\mathrm{PW}^{\mathrm{hol},\mathrm{HFD}}_{F}\cup\mathrm{PW}^{\mathrm{hol},\mathrm{HD}}_{F}$
(wave-7 F), via a contour-integration route disjoint from the
Hurwitz-series route of wave-6. The residual is named precisely, the
