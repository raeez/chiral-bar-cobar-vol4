...
categorical descent of route~5E, yielding the full sph-finite
...
(\Cref{v4-arith:w5-e:thm:LACD-cuspidal}), the route~5E core
theorem;
...
Route~5E derived the cuspidal LACD through Flath 1979 + Bernstein
...
derivation sources of route~5E (Flath, Bernstein, Mo{\oe}glin--Waldspurger
...
sides, but in disjoint chapters (\S III cuspidal on the route~5E
...
(\Cref{v4-arith:tate:thm:F2c-main}), route~5E cuspidal
(\Cref{v4-arith:w5-e:thm:LACD-cuspidal}). The route~5E cuspidal
...
distinguished-unit hypothesis tracks through from route~5E.
...
\subsection{Composite with Route~5E}

\begin{theorem}[composite $\mathrm{L}_{\mathrm{ACD}}$ theorem after Route~5E + W6-D]
\label{v4-arith:w6-d:thm:composite-LACD}
\ClaimStatusProvedHere. Combining route~5E cuspidal closure
...
\ClaimStatusProvedHere. Combining this chapter with the route~5E
...
\end{enumerate}
The total scope drops from 100--165 pp (after route~5E) to
80--130 pp (after W6-D).
\end{proposition}

\begin{proof}
Tabulation. Route~5E carried the Eisenstein residual at 30--50 pp;
...
(\Cref{v4-arith:w6-d:thm:composite-LACD}): route~5E cuspidal +
