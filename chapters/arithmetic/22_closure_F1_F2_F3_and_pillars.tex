...
This chapter executes the attack-and-repair protocol on each conjecture,
...
\section{Attack-and-Repair Protocol Recalled}
...
Gan--Savin 2022 for partial progress).
...
$GL_{2}/\mathbb{Q}$ and should admit a uniform treatment. Fresse's
\emph{Homotopy of Operads} and Lurie HA provide the operadic infrastructure;
