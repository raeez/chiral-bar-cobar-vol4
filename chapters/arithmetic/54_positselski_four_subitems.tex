...
\emph{Of the five open Positselski sub-items named in wave-3 audit OC1
...
arXiv:math/9508003 combined with Consani--Marcolli adele-class
...
$R$-modules and Artinian $R$-modules. Moreover, $(-)^{\mathrm{M}\mathrm{M}}$
...
(arXiv:math/9508003) is the $C^{\ast}$-dynamical system
\begin{equation}
...
411--457 (arXiv:math/9508003). \S1.2 presentation of
$\mathbb{A}^{\mathrm{BC}}=C^{\ast}_{r}(\mathbb{Q}^{\ast}_{+}\rtimes\hat{\mathbb{Z}}^{\ast})$
...
wave-1/wave-2 ledger sense, completing the full arithmetic
