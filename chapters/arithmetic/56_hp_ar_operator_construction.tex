...
\begin{remark}[reference to wave-4 construction]
...
regularisation as an operator input, only to match the wave-3 ledger
...
We now recall the arithmetic Heisenberg Fock on which the candidate
...
\Cref{v4-arith:hpvbconv:rem:berry-keating} for the wave-2 discussion.
\end{remark}
...
\item The wave-2 structural analysis
...
absorption-spectrum condition. The equivalence is the wave-2
...
spectrum. In the wave-3 ledger vocabulary, (W) is closed
...
(W) weight existence in the wave-3 ledger & Closed (with $\lambda_{\mathrm{BK}}$) & \Cref{v4-arith:w5-b:rem:W-honest} \\
(H) H-P trace bridge in the wave-3 ledger & Open; equivalent to twist existence & \Cref{v4-arith:w5-b:thm:precise-obstruction}
\end{tabular}
\end{center}
...
verification. The wave-3 catalogue of
\Cref{v4-arith:hpar-det:sources} is disjoint from the wave-2
