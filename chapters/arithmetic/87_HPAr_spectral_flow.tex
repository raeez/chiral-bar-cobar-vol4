...
We isolate the irreducible residual and name it precisely.
...
proven within the Vol~IV route~6 / route~7 ledger
...
classification. It only kills the ordinary point-supported
graph-dual route. Assuming the closed Tate-polar quotient and residual
Meyer chart have been constructed, a surviving operator obstruction
must avoid that route. The known nonexclusive presentations are:
\begin{enumerate}
...
stronger-topology route would require, at minimum, a continuous
...
We execute the graph-norm closure request in the currently
...
\item \Cref{v4-arith:HPAr-vbconverse}: route~2 equivalence bundle
(Ch.~\ref{v4-arith:HPAr-vbconverse}).
\item \Cref{v4-arith:hpar-det}: route~3 determinacy ledger
