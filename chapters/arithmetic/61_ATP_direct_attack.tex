...
\emph{Wave-5 (Chapter~\ref{v4-arith:w5-a:chapter}) closed the
...
The wave-6 attack on A-TP has produced the following outcomes.
...
Connes--Deninger routes. The wave-6 A closure is that the
...
\begin{remark}[comparison to wave-5 residual]
\label{v4-arith:w6-a:rem:compare-w5}
Wave-5 A (\Cref{v4-arith:w5-a:chapter}) left A-TP as ``the
archimedean Tate distribution, positivity strictly equivalent to RH,
irreducibly open.'' The wave-6 A attack refines this:
\begin{itemize}
...
propositions.
\end{itemize}
The RH-equivalent residual persists. What wave-6 adds is precision:
...
The wave-6 A deliverable obeys the Beilinson principle: a smaller
