...
\emph{Route~2 auditor A2-BZN-01 surfaced two independent defects in
...
\subsection{The Route~2 Ledger Entry}

Route~2 auditor A2-BZN-01 (Etingof lens, hypotheses check), recorded
in Chapter~\ref{v4-arith:audit} at
...
catalogued by route~2 auditor A2-BZN-01.
...
The proof threads six attack-and-repair cycles: three on R3
...
\subsection{Attack-and-Repair Trace for R3 Cycle 1}
...
\subsection{Attack-and-Repair Trace for R3 Cycle 2}
...
\subsection{Attack-and-Repair Trace for R3 Cycle 3}
...
\subsection{Attack-and-Repair Trace for R4 Cycles 4 and 5}
...
\subsection{Attack-and-Repair Trace for R4 Cycle 6 and Correction}
...
\section{Consistency with Route~1 Chapter~28}
...
attack-and-repair cycles of its \S \ref{v4-arith:bzn:ledger}) is
...
\ClaimStatusNeedsVerification. The route~1 inscription of
F3.BZN${}^{\mathrm{Ar}}$
...
Within the Chapter~\ref{v4-arith:audit} ledger:
\begin{itemize}
...
The route~2 loop-convention defect D4 is isolated by the R3 convention.
