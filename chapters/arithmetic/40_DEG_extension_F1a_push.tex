...
\emph{Route~2 overclaimed F1.a as closed via Fargues--Scholze.
...
\subsection{What Route~2 Closed, What Route~2 Overclaimed}
...
identified as the input supply. The route~2 ledger entry was accurate
...
volume; prohibited process vocabulary is excluded throughout.

\section{Attack-and-Repair Ledger}
\label{v4-arith:deg-f1a:ledger}

Six attack-and-repair cycles structure this chapter. Each cycle includes
...
\subsection{Attack-and-Repair Trace for Cycles 2 and 3}
...
\subsection{Attack-and-Repair Trace for Cycle 4}
...
\subsection{Attack-and-Repair Trace for Cycle 6}

\paragraph{Attack 1.} Sources: \Cref{v4-arith:cl:cor:F1-single-lemma}
(route~2 F1 reduction), plus the local-categorical-comparison
...
\begin{enumerate}
\item Route~2 overclaimed F1.a as closed via Fargues--Scholze. The
