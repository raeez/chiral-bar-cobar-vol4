...
\mathrm{D}^{\mathrm{sph\text{-}fin}}\bigl([GL_{2}]\bigr)\;\simeq\;\mathrm{IndCoh}_{\mathrm{Nilp}}\bigl(\mathcal{X}^{\mathrm{Sel}}_{\bar\rho,\det,\mathcal{L}}\bigr).
\end{equation}
\end{theorem}
...
(H1)+(H2)+(H3), up to the wild-enhancement of the local conditions
